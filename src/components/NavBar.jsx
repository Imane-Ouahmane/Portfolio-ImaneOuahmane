...
function NavBar() {
  ...
  return (
    <div className='flex justify-between items-center w-full h-20 px-4 text-white bg-black fixed z-50'>
      <div>
        <h1 className='text-5xl font-signature ml-2'>Imane </h1>
      </div>
      <ul className='hidden md:flex'>

        {links.map(({id, link})=>(
            <li key={id} className='px-4 pr-8 cursor-pointer capitalize font-medium
            text-gray-500 hover:text-white hover:scale-125 duration-200 '>
